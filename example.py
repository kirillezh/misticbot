...
testing_inform = 'ЭТО ТЕСТИРОВАНИЕ, ЭТО НЕ ОБЬЯВЛЕНИЕ ТРЕВОГИ!!!!!!!'

master_xuilo = ['Путин хуйло', 'Їбав я путіна у сраку!', 'Путин пошёл нахуй!', 'Ебал я путина!', 'Путин хуйло!', 'Путин пидорас!', 'Нахуй Путина!', 'Когда ж здохнет Путин?!', 'Путин пидор', 'Путин сосёт у ВСУ']
...
close_i= ['Закрываем тему.', 'Close the topic.', ' Konu kapandi.', 'Закриваємо тему.', '關閉主題.']
